        ...
        <footer className="bg-dark text-light mnx-footer">
            <Container className="py-5">
                <Row>
                    ...
                    <Col md={2} className="offset-md-1">
                        <div className="lc-block small">
                            ...
                            <p>{authContext.sessionInfo ?
                                <Link to={"/request-access"}>{t("be_a_representative")}</Link> 
                                :
                                <Link to={"/new-seller"}>{t("be_a_representative")}</Link>
                            }</p>
                        </div>
                    </Col>
                    ...
                    <Col md={2} className="offset-md-1">
                        <div className="lc-block small">
                            <p><Link to={"/account/login?returnUrl=%2Fadmin%2Fdashboard"}>{t('footer_dashboard')}</Link></p>
                        </div>
                    </Col>
                </Row>
            </Container>
