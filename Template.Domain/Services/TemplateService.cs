...
namespace Template.Domain.Impl.Services
{
    public class TemplateService : ITemplateService
    {
        ...
        public ITemplatePageModel GetOrCreateNetworkPage(long networkId, string pageSlug)
        {
            var template = _templateFactory.BuildTemplateModel().GetByNetwork(networkId, _templateFactory);
            if (template == null)
            {
                template = CreateDefaultNetworkTemplate(networkId);
            }
